...
(function() {
  const template = document.createElement('template');
    ...
    var url = "../javascripts/mn-buy-button.js";
    script.src = url;
  ...
  template.innerHTML = `
    ...
    <div  class="mn-product-content">
        <script src="../javascripts/mn-buy-button.js"></script>
  ...
  class MnProduct extends HTMLElement {
    ...
    displayProduct(data) {
        ...
        for (var i=0; i<items.length; i++){
            tmp += `<tr>
                    <td>${items[i]}</td>
                    <td><my-buy-button>Buy</my-buy-button></td>`
                    + '<td>%3Cmy-buy-button%3E%3C%2Fmy-buy-button%3E</td>'
                    + `</tr>`;
        }
